package com.live.dreamiptv.v1.Home;
...
import com.live.dreamiptv.v1.Live.LiveMainActivity;
import com.live.dreamiptv.v1.R;
import com.live.dreamiptv.v1.Utilities;
import com.live.dreamiptv.v1.Vod.VodMainActivity;
...
public class HomeActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        vodBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(mContext, VodMainActivity.class);
                startActivity(intent);
            }
        });
