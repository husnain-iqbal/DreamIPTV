package com.live.dreamiptv.v1.Vod;
...
import com.live.dreamiptv.v1.Vod.VideoCategoryList.VideoCategoryDetailFragment;
...
public class VodMainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fragmentTransaction.add(R.id.fragment_one_vod, new VideoCategoryDetailFragment(), Utilities.FRAGMENT_ONE_TAG);
    ...
    public void onBackPressed() {
        if (VodUtils.isUserOnLargeScreen()) {
            VideoPlayFragment fragmentThree = (VideoPlayFragment) getSupportFragmentManager().findFragmentById(R.id.fragment_three_vod);
            if (fragmentThree != null) {
                fragmentThree.compressVideoView();
                VideoListFragment fragmentTwo = (VideoListFragment) getSupportFragmentManager().findFragmentById(R.id.fragment_two_vod);
                if (fragmentTwo != null) {
                    fragmentTwo.setFocusOnCurrentItem();
                }
            }
            return;
        }
